...
[![CD - AWS deployment and Testing](https://github.com/sparki-json/break-games-vm/actions/workflows/cd.yml/badge.svg)](https://github.com/sparki-json/break-games-vm/actions/workflows/cd.yml)
...
- [x] CD pipline through GitHub actions to deploy into Terraform-created AWS instance
### Future Nice-TO-DOs
